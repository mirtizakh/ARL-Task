package com.task.sample.data.network.api_call

data class Resource<out T>(
    val status: ResponseStatus, val responseData: T? = null,
    ...
    companion object {
        ...
        fun <T> apiCrashError(): Resource<T> {
            return Resource(ResponseStatus.APICRASH_ERROR)
        }
        ...
        //401
        fun <T> authError(): Resource<T> {
            return Resource(ResponseStatus.AUTH_ERROR)
        }
